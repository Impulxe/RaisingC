  ...
  return (
    <>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-15">
          <Image
            src="https://i.imgur.com/DQAbN9n.png"
            alt=""
            width={100}
            height={100}
          ...
          />
          <Image
            src="https://i.imgur.com/3sOKaqY.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/rhCuqqm.png"
            alt=""
            width={160}
            height={160}
            className="absolute top-1/3 left-20 w-15 h-15 object-contain animate-float-gentle"
          />
          <Image
            src="https://i.imgur.com/ryxbC33.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/voVXkzx.png"
            alt=""
            width={160}
            height={160}
          ...
          />
          <Image
            src="https://i.imgur.com/KBul9Zr.png"
            alt=""
            width={80}
            height={80}
